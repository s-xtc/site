(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[923], {
    ...
    9578: function(e, t, n) {
        ...
        var a = void 0 !== r && r.env && !0
          ...
          , u = function() {
            ...
            n.insertRule = function(e, t) {
                if (c(l(e), "`insertRule` accepts only strings"),
                this._optimizeForSpeed) {
                    var n = this.getSheet();
        ...
        function h(e, t) {
            ...
            var n = String(t)
              , r = e + n;
            return p[r] || (p[r] = "jsx-" + d(e + "-" + n)),
            p[r]
        }
        function f(e, t) {
            var n = e + t;
            return p[n] || (p[n] = t.replace(/__jsx-style-dynamic-selector/g, e)),
            p[n]
        }
        var m = function() {
            function e(e) {
    ...
    590: function(e, t, n) {
        ...
        function m(e, t) {
            ...
            for (let r in f)
                r in p ? r in e && !(r in n) && (n[r] = p[r]) : r in t ? n[r] = t[r] : r in e && (n[r] = e[r]);
            return n
        }
        function g(e, t) {
            let n = [];
        ...
        function A(e) {
            if ("object" != typeof e || null === e || "string" != typeof e.prefix || !e.icons || "object" != typeof e.icons || !y(e, v))
                return null;
            let t = e.icons;
            for (let e in t) {
                let n = t[e];
                if (!e.match(l) || "string" != typeof n.body || !y(n, f))
                    return null
            }
            ...
            for (let e in n) {
                let r = n[e]
                  , i = r.parent;
                if (!e.match(l) || "string" != typeof i || !t[i] && !n[i] || !y(r, f))
                    return null
            }
            return e
        }
        ...
        let N = Object.create(null)
          ...
          , B = [];
        for (; F.length > 0; )
            1 === F.length ? B.push(F.shift()) : Math.random() > .5 ? B.push(F.shift()) : B.push(F.pop());
        N[""] = I({
            ...
            return {
                query: function(e, i, o) {
                    let s = function(e, t, n, r) {
                        ...
                        return "function" == typeof r && h.push(r),
        ...
        function ea(e) {
            let t = e + "Storage";
            try {
                if (es && es[t] && "number" == typeof es[t].length)
                    return es[t]
            } catch (e) {}
            er[e] = !1
        }
        ...
        let eE = (e,t,n,i)=>{
            ...
            let p = function(e, t) {
                ...
                let l = o.width
                  ...
                  , c = s.width
                  , d = s.height;
                null === l ? n = L(r = null === u ? "1em" : "auto" === u ? d : u, c / d) : (n = "auto" === l ? c : l,
                r = null === u ? L(n, d / c) : "auto" === u ? d : u);
                let p = {}
                  , f = (e,t)=>{
                    P(t) || (p[e] = t.toString())
                }
                ...
                return f("width", n),
                f("height", r),
                p.viewBox = s.left.toString() + " " + s.top.toString() + " " + c.toString() + " " + d.toString(),
                {
                    attributes: p,
                    body: a
                }
              ...
              , f = p.attributes;
            if (s.inline && (u.verticalAlign = "-0.125em"),
            "svg" === l) {
                var m;
                d.style = {
                    ...u,
            ...
            _checkIcon(e) {
                ...
                if (!i) {
                    ...
                    null !== i && (this._loading = {
                        name: r,
                        abort: ed([t], this._checkIcon.bind(this, !1))
                    }));
                    return
                }
        ...
        class eM extends a.Component {
            constructor() {
                ...
                o(this, "handleMouseDownOrTouchStartProgressBar", e=>{
                    ...
                    isFinite(t) && (this.timeOnMouseMove = t,
                    this.setState({
                        isDraggingProgress: !0,
                        currentTimePos: n
                    }),
                    e.nativeEvent instanceof MouseEvent ? (window.addEventListener("mousemove", this.handleWindowMouseOrTouchMove),
                    window.addEventListener("mouseup", this.handleWindowMouseOrTouchUp)) : (window.addEventListener("touchmove", this.handleWindowMouseOrTouchMove),
                ...
                o(this, "handleWindowMouseOrTouchUp", e=>{
                    ...
                    if (i)
                        ...
                        n.readyState !== n.HAVE_NOTHING && n.readyState !== n.HAVE_METADATA && isFinite(t) ? n.currentTime = t : (e.currentTimePos = "0%",
                        r && r()),
                        this.setState(e)
                    }
                    e instanceof MouseEvent ? (window.removeEventListener("mousemove", this.handleWindowMouseOrTouchMove),
                    window.removeEventListener("mouseup", this.handleWindowMouseOrTouchUp)) : (window.removeEventListener("touchmove", this.handleWindowMouseOrTouchMove),
                    window.removeEventListener("touchend", this.handleWindowMouseOrTouchUp))
                }
                ),
                o(this, "handleAudioTimeUpdate", eP(e=>{
                    let {isDraggingProgress: t} = this.state
                      , n = e.target;
                    if (t || !0 === this.state.waitingForSeekCallback)
                        return;
                    let {currentTime: r} = n
                      , i = this.getDuration();
                    this.setState({
                        currentTimePos: `${(r / i * 100 || 0).toFixed(2)}%`
                    })
                }
                ...
                o(this, "handleAudioDownloadProgressUpdate", e=>{
                    ...
                    for (let e = 0; e < t.buffered.length; e++) {
                        let i = t.buffered.start(e)
                          , o = t.buffered.end(e);
                        r.push({
                            left: `${Math.round(100 / n * i) || 0}%`,
                            width: `${Math.round(100 / n * (o - i)) || 0}%`
                        })
                    }
            ...
            componentDidUpdate() {
                ...
                e && !this.hasAddedAudioEventListener && (this.audio = e,
                this.hasAddedAudioEventListener = !0,
                e.addEventListener("timeupdate", this.handleAudioTimeUpdate),
                e.addEventListener("progress", this.handleAudioDownloadProgressUpdate))
            }
            componentWillUnmount() {
                this.audio && this.hasAddedAudioEventListener && (this.audio.removeEventListener("timeupdate", this.handleAudioTimeUpdate),
        ...
        let ej = (e,t)=>a.createElement(eM, ex({}, e, {
            progressBar: t
        }));
        var ek = (0,
        a.forwardRef)(ej);
        class eR extends a.PureComponent {
            constructor(e) {
                ...
                o(this, "handleAudioCurrentTimeChange", e=>{
                    ...
                    this.setState({
                        currentTime: eL(n ? t.duration - t.currentTime : t.currentTime, t.duration, r) || i
                    })
                }
                ),
                o(this, "addAudioEventListeners", ()=>{
                    ...
                    e && !this.hasAddedAudioEventListener && (this.audio = e,
                    this.hasAddedAudioEventListener = !0,
                    e.addEventListener("timeupdate", this.handleAudioCurrentTimeChange),
                    e.addEventListener("loadedmetadata", this.handleAudioCurrentTimeChange))
                }
                );
                let {audio: t, defaultCurrentTime: n, isLeftTime: r, timeFormat: i} = e
                  , s = n;
                t && (s = eL(r ? t.duration - t.currentTime : t.currentTime, t.duration, i)),
                this.state = {
                    currentTime: s
                }
            }
            ...
            componentWillUnmount() {
                this.audio && this.hasAddedAudioEventListener && (this.audio.removeEventListener("timeupdate", this.handleAudioCurrentTimeChange),
        ...
        class eD extends a.PureComponent {
            constructor(e) {
                ...
                o(this, "hasAddedAudioEventListener", !1),
                o(this, "state", {
                    duration: this.props.audio ? eL(this.props.audio.duration, this.props.audio.duration, this.props.timeFormat) : this.props.defaultDuration
                }),
                o(this, "handleAudioDurationChange", e=>{
                    let t = e.target
                      , {timeFormat: n, defaultDuration: r} = this.props;
                    this.setState({
                        duration: eL(t.duration, t.duration, n) || r
                    })
                }
                ),
                o(this, "addAudioEventListeners", ()=>{
                    ...
                    e && !this.hasAddedAudioEventListener && (this.audio = e,
                    this.hasAddedAudioEventListener = !0,
                    e.addEventListener("durationchange", this.handleAudioDurationChange),
                    e.addEventListener("abort", this.handleAudioDurationChange))
                }
                );
                let {audio: t, timeFormat: n, defaultDuration: r} = e;
                this.state = {
                    duration: t ? eL(t.duration, t.duration, n) : r
                }
            }
            componentDidMount() {
                this.addAudioEventListeners()
            ...
            componentWillUnmount() {
                this.audio && this.hasAddedAudioEventListener && (this.audio.removeEventListener("durationchange", this.handleAudioDurationChange),
        ...
        class eI extends a.Component {
            constructor() {
                ...
                o(this, "handleClickVolumeButton", ()=>{
                    let {audio: e} = this.props;
                    e.volume > 0 ? (this.lastVolume = e.volume,
                    e.volume = 0) : e.volume = this.lastVolume
                }
                ),
            ...
            componentWillUnmount() {
                this.audio && this.hasAddedAudioEventListener && this.audio.removeEventListener("volumechange", this.handleAudioVolumeChange),
                clearTimeout(this.volumeAnimationTimer)
            }
            render() {
        ...
        let eN = ((s = {}).CURRENT_TIME = "CURRENT_TIME",
        ...
        class eF extends a.Component {
            constructor() {
                ...
                o(this, "setJumpTime", e=>{
                    ...
                    if (t.readyState === t.HAVE_NOTHING || t.readyState === t.HAVE_METADATA || !isFinite(n) || !isFinite(r))
                        return this.props.onChangeCurrentTimeError && this.props.onChangeCurrentTimeError();
                    let i = r + e / 1e3;
                    i < 0 ? (t.currentTime = 0,
                    i = 0) : i > n ? (t.currentTime = n,
                    i = n) : t.currentTime = i
                }
                ),
                ...
                o(this, "handleKeyDown", e=>{
                    if (this.props.hasDefaultKeyBindings)
                        switch (e.key) {
                        case " ":
                            (e.target === this.container.current || e.target === this.progressBar.current) && (e.preventDefault(),
                            this.togglePlay(e));
                            break;
                        case "ArrowLeft":
                ...
                o(this, "renderUIModule", (e,t)=>{
                    let {defaultCurrentTime: n, progressUpdateInterval: r, showDownloadProgress: i, showFilledProgress: o, showFilledVolume: s, defaultDuration: l, customIcons: u, showSkipControls: c, onClickPrevious: d, onClickNext: p, onChangeCurrentTimeError: h, showJumpControls: f, customAdditionalControls: m, customVolumeControls: g, muted: v, timeFormat: y, volume: A, loop: b, mse: w, i18nAriaLabels: E} = this.props;
                    switch (e) {
                    ...
                    case eN.DURATION:
                        ...
                        }, w && w.srcDuration ? eL(w.srcDuration, w.srcDuration, this.props.timeFormat) : a.createElement(eD, {
                            audio: this.audio.current,
                            defaultDuration: l,
                            timeFormat: y
                        }));
                    ...
                    case eN.MAIN_CONTROLS:
                        {
                            ...
                            return e = n ? u.pause ? u.pause : a.createElement(eS, {
                                icon: "mdi:pause-circle"
                            }) : u.play ? u.play : a.createElement(eS, {
                            ...
                            a.createElement("div", {
                                ...
                                type: "button",
                                onClick: d
                            }, u.previous ? u.previous : a.createElement(eS, {
                            ...
                            }, u.rewind ? u.rewind : a.createElement(eS, {
                                icon: "mdi:rewind"
                            })), a.createElement("button", {
                                "aria-label": n ? E.pause : E.play,
                                className: "rhap_button-clear rhap_main-controls-button rhap_play-pause-button",
                                type: "button",
                                onClick: this.togglePlay
                            }, e), f && a.createElement("button", {
                                "aria-label": E.forward,
                                className: "rhap_button-clear rhap_main-controls-button rhap_forward-button",
                                type: "button",
                                onClick: this.handleClickForward
                            }, u.forward ? u.forward : a.createElement(eS, {
                                ...
                                type: "button",
                                onClick: p
                            }, u.next ? u.next : a.createElement(eS, {
                                icon: "mdi:skip-next"
                            })))
                        }
                    ...
                    case eN.LOOP:
                        {
                            ...
                            return e = n ? u.loop ? u.loop : a.createElement(eS, {
                                icon: "mdi:repeat"
                            }) : u.loopOff ? u.loopOff : a.createElement(eS, {
                                icon: "mdi:repeat-off"
                            }),
                            a.createElement("button", {
                                key: t,
                                "aria-label": n ? E.loop : E.loopOff,
                    ...
                    case eN.VOLUME:
                        {
                            ...
                            return e = n ? u.volume ? u.volume : a.createElement(eS, {
                                icon: "mdi:volume-high"
                            }) : u.volume ? u.volumeMute : a.createElement(eS, {
                            ...
                            a.createElement("div", {
                                ...
                                "aria-label": n ? E.volume : E.volumeMute,
                                onClick: this.handleClickVolumeButton,
                                type: "button",
                                className: "rhap_button-clear rhap_volume-button"
                            }, e), a.createElement(eI, {
                                audio: this.audio.current,
                                volume: n,
                                onMuteChange: this.handleMuteChange,
                                showFilledVolume: s,
                                i18nVolumeControl: E.volumeControl
                            }))
                        }
                    default:
                        if (!(0,
            ...
            componentDidMount() {
                ...
                e.addEventListener("timeupdate", eP(e=>{
            ...
            render() {
                let {className: e, src: t, loop: n, preload: r, autoPlay: i, crossOrigin: o, mediaGroup: s, header: l, footer: u, layout: c, customProgressBarSection: d, customControlsSection: p, children: h, style: f, i18nAriaLabels: m} = this.props
                ...
                }, this.renderUIModules(d)), a.createElement("div", {
                    className: "rhap_controls-section"
                }, this.renderUIModules(p))), u && a.createElement("div", {
            ...
            var e = {
                    ...
                    let T = function() {
                        ...
                        function t(e, n) {
                            ...
                            S(this, "setupWrapperElement", function() {
                                A.state.elements.container && (A.state.elements.wrapper.className = A.options.wrapperClassName,
                            ...
                            S(this, "start", function() {
                                return A.state.eventLoopPaused = !1,
                                A.runEventLoop(),
                                A
                            }),
                            S(this, "pause", function() {
                                return A.state.eventLoopPaused = !0,
                                A
                            }),
                            S(this, "stop", function() {
                                return A.state.eventLoop && ((0,
                                r.cancel)(A.state.eventLoop),
                                A.state.eventLoop = null),
                                A
                            }),
                            S(this, "pauseFor", function(e) {
                                return A.addEventToQueue(d, {
                                    ms: e
                                }),
                                A
                            }),
                            S(this, "typeOutAllStrings", function() {
                                return "string" == typeof A.options.strings ? (A.typeString(A.options.strings).pauseFor(A.options.pauseFor),
                                A) : (A.options.strings.forEach(function(e) {
                            ...
                            S(this, "typeString", function(e) {
                                ...
                                if (o(e))
                                    return A.typeOutHTMLString(e, t);
                                if (e) {
                            ...
                            S(this, "pasteString", function(e) {
                                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
                                return o(e) ? A.typeOutHTMLString(e, t, !0) : (e && A.addEventToQueue(v, {
                                    character: e,
                                    node: t
                                }),
                                A)
                            ...
                            S(this, "typeOutHTMLString", function(e) {
                                var t, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null, r = arguments.length > 2 ? arguments[2] : void 0, i = ((t = document.createElement("div")).innerHTML = e,
                                t.childNodes);
                                if (i.length > 0)
                                    for (var o = 0; o < i.length; o++) {
                                        ...
                                        r ? A.pasteString(a, s) : A.typeString(a, s)) : s.textContent && (r ? A.pasteString(s.textContent, n) : A.typeString(s.textContent, n))
                                    }
                                return A
                            }),
                            S(this, "deleteAll", function() {
                                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "natural";
                                return A.addEventToQueue(u, {
                                    speed: e
                                }),
                                A
                            }),
                            ...
                            S(this, "addEventToStateProperty", function(e, t) {
                                ...
                                return A.state[r] = n ? [i].concat(E(A.state[r])) : [].concat(E(A.state[r]), [i]),
                                A
                            }),
                            S(this, "runEventLoop", function() {
                                ...
                                if (!A.state.eventQueue.length) {
                                    if (!A.options.loop)
                                        return;
                                    A.state.eventQueue = E(A.state.calledEvents),
                                    A.state.calledEvents = [],
                                    A.options = w({}, A.state.initialOptions)
                                }
                                if (A.state.eventLoop = i()(A.runEventLoop),
                                !A.state.eventLoopPaused) {
                                    if (A.state.pauseUntil) {
                                        if (e < A.state.pauseUntil)
                                            return;
                                        A.state.pauseUntil = null
                                    }
                                    var n, r = E(A.state.eventQueue), o = r.shift();
                                    if (!(t <= (n = o.eventName === c || o.eventName === l ? "natural" === A.options.deleteSpeed ? s(40, 80) : A.options.deleteSpeed : "natural" === A.options.delay ? s(120, 160) : A.options.delay))) {
                                        var b = o.eventName
                                          , _ = o.eventArgs;
                                        switch (A.logInDevMode({
                                            currentEvent: o,
                                            state: A.state,
                                            delay: n
                                        }),
                                        ...
                                        case a:
                                            ...
                                            A.state.visibleNodes = [].concat(E(A.state.visibleNodes), [{
                                                type: "TEXT_NODE",
                                                character: S,
                                                node: C
                                            }]);
                                        ...
                                        case h:
                                            ...
                                            A.state.visibleNodes = [].concat(E(A.state.visibleNodes), [{
                                                type: y,
                                                node: k,
                                                parentNode: R || A.state.elements.wrapper
                                            }]);
                                            break;
                                        case u:
                                        ...
                                        case c:
                                            ...
                                            if (A.state.visibleNodes.length) {
                                                var U = A.state.visibleNodes.pop()
                                                  ...
                                                  , H = U.node
                                                  , Y = U.character;
                                                A.options.onRemoveNode && "function" == typeof A.options.onRemoveNode && A.options.onRemoveNode({
                                                    node: H,
                                                    character: Y
                                                }),
                                        ...
                                        case m:
                                            ...
                                            break;
                                        case g:
                                            A.options.cursor = o.eventArgs.cursor,
                                            A.state.elements.cursor.innerHTML = o.eventArgs.cursor
                                        }
                ...
                4636: (e,t,n)=>{
                    ...
                    e.exports = function(e, t) {
                        var n = o(e)
                          ...
                          , m = f.length;
                        for (var g in e)
                            !t && !u.call(e, g) || h && ("length" == g || d && ("offset" == g || "parent" == g) || p && ("buffer" == g || "byteLength" == g || "byteOffset" == g) || a(g, m)) || f.push(g);
                        return f
                    }
                }
                ,
                ...
                2492: (e,t,n)=>{
                    ...
                    e.exports = function(e, t, n, m, g, v) {
                        ...
                        if (S && !E)
                            return v || (v = new r),
                            y || c(e) ? i(e, t, n, m, g, v) : o(e, t, b, n, m, g, v);
                        if (!(1 & n)) {
                    ...
                    e.exports = function(e, t, n, s, a, l) {
                        ...
                        l.set(t, e); ++f < c; ) {
                            var v = e[f]
                              , y = t[f];
                            if (s)
                                var A = u ? s(y, v, f, t, e, l) : s(v, y, f, e, t, l);
                            if (void 0 !== A) {
                                if (A)
                                    continue;
                                m = !1;
                    ...
                    e.exports = function(e, t, n, o, s, a) {
                        ...
                        for (var g = l; ++d < c; ) {
                            var v = e[p = u[d]]
                              , y = t[p];
                            if (o)
                                var A = l ? o(y, v, p, t, e, a) : o(v, y, p, e, t, a);
                ...
                4160: (e,t,n)=>{
                    var r = n(8552)
                      ...
                      , A = u(a)
                      , b = l;
                    (r && b(new r(new ArrayBuffer(1))) != f || i && b(new i) != c || o && b(o.resolve()) != d || s && b(new s) != p || a && b(new a) != h) && (b = function(e) {
                        var t = l(e)
                ...
                ,
                5346: (e,t,n)=>{
                    var r, i = n(4429), o = (r = /[^.]+$/.exec(i && i.keys && i.keys.IE_PROTO || "")) ? "Symbol(src)_1." + r : "";
                    e.exports = function(e) {
                        return !!o && o in e
                    }
                }
                ...
                75: function(e) {
                    (function() {
                        ...
                        )() - 1e9 * i.uptime()) : Date.now ? (e.exports = function() {
                            return Date.now() - r
                        }
                        ,
                ...
                4087: (e,t,n)=>{
                    for (var r = n(75), i = "undefined" == typeof window ? n.g : window, o = ["moz", "webkit"], s = "AnimationFrame", a = i["request" + s], l = i["cancel" + s] || i["cancelRequest" + s], u = 0; !a && u < o.length; u++)
                        a = i[o[u] + "Request" + s],
                        l = i[o[u] + "Cancel" + s] || i[o[u] + "CancelRequest" + s];
                    if (!a || !l) {
                        var c = 0
                          , d = 0
                          , p = [];
                ...
                var p = function(e) {
                    ...
                    function p() {
                        ...
                        for (var i = arguments.length, s = Array(i), a = 0; a < i; a++)
                            s[a] = arguments[a];
                        return t = u(e = o.call.apply(o, [this].concat(s))),
                        r = {
                            instance: null
                        },
                        (n = d(n = "state"))in t ? Object.defineProperty(t, n, {
                            value: r,
                            enumerable: !0,
                            configurable: !0,
                            writable: !0
    ...
    689: function(e, t, n) {
        ...
        var r, i, o, s, a, l, u, c, d = n(7294), p = n.t(d, 2);
        function h(e, t, ...n) {
            if (e in t) {
                let r = t[e];
        ...
        function y(e, t={}, n, r) {
            ...
            if (i === d.Fragment && Object.keys(w(a)).length > 0) {
                if (!(0,
                d.isValidElement)(u) || Array.isArray(u) && u.length > 1)
...
`));
                ...
                return (0,
                d.cloneElement)(u, Object.assign({}, A(u.props, w(E(a, ["ref"]))), c, l, function(...e) {
                    return {
            ...
            return (0,
            d.createElement)(i, Object.assign({}, E(a, ["ref"]), i !== d.Fragment && l, i !== d.Fragment && c), u)
        }
        function A(...e) {
            if (0 === e.length)
                return {};
        ...
        var _ = Object.defineProperty
          , S = (e,t,n)=>t in e ? _(e, t, {
            enumerable: !0,
            configurable: !0,
            writable: !0,
            value: n
        }) : e[t] = n
          , x = (e,t,n)=>(S(e, "symbol" != typeof t ? t + "" : t, n),
        n);
        let T = new class {
            constructor() {
        ...
        let M = null != (u = d.useId) ? u : function() {
            let e = function() {
                let e;
                ...
                return n && !1 === T.isHandoffComplete && r(!1),
                d.useEffect(()=>{
                    !0 !== n && r(!0)
                }
                , [n]),
        ...
        var R = ((s = R || {})[s.Open = 1] = "Open",
        s[s.Closed = 2] = "Closed",
        s[s.Closing = 4] = "Closing",
        s[s.Opening = 8] = "Opening",
        s);
        ...
        let N = null != (c = d.startTransition) ? c : function(e) {
            e()
        }
        ;
        var F = ((a = F || {})[a.Open = 0] = "Open",
        a[a.Closed = 1] = "Closed",
        a)
          , B = ((l = B || {})[l.ToggleDisclosure = 0] = "ToggleDisclosure",
        ...
        let X = d.Fragment
          ...
          , $ = Object.assign(b(function(e, t) {
            let {defaultOpen: n=!1, ...r} = e
              , i = (0,
            d.useRef)(null)
              , o = P(t, function(e, t=!0) {
                ...
                let n = M()
                  ...
                  , {close: a} = function e(t) {
                    ...
                    if (null === n) {
                        ...
                        throw Error.captureStackTrace && Error.captureStackTrace(n, e),
                        n
                    }
                    return n
                }("Disclosure.Panel")
    ...
    1562: function(e, t, n) {
        "use strict";
        function r(e) {
            let t, n, r, i = e && e.colors || ["#D61C59", "#E7D84B", "#1B8798"], o = e && e.element, s = o || document.body, a = window.innerWidth, l = window.innerHeight, u = {
                x: a / 2,
                y: a / 2
            }, c = {
                x: a / 2,
                y: a / 2
            }, d = [], p = [], h = window.matchMedia("(prefers-reduced-motion: reduce)");
            function f() {
                if (h.matches)
            ...
            function m(e) {
                ...
                t.height = s.clientHeight) : (t.width = a,
                t.height = l)
            }
            function g(e) {
                if (e.touches.length > 0)
                    for (let t = 0; t < e.touches.length; t++)
                        y(e.touches[t].clientX, e.touches[t].clientY, p[Math.floor(Math.random() * p.length)])
            }
            function v(e) {
                window.requestAnimationFrame(()=>{
                    if (o) {
                        let t = s.getBoundingClientRect();
                        u.x = e.clientX - t.left,
                        u.y = e.clientY - t.top
                    } else
                        u.x = e.clientX,
                        u.y = e.clientY;
                    Math.hypot(u.x - c.x, u.y - c.y) > 1.5 && (y(u.x, u.y, p[Math.floor(Math.random() * i.length)]),
                    c.x = u.x,
                    c.y = u.y)
                }
                )
        ...
        function i(e) {
            let t, n, r, i = e && e.element, o = i || document.body, s = window.innerWidth, a = window.innerHeight, l = {
                x: s / 2,
                y: s / 2
            }, u = [], c = e?.particles || 15, d = e?.rate || .4, p = e?.baseImageSrc || "data:image/png;base64,", h = !1, f = new Image;
            f.src = p;
            ...
            function g() {
                ...
                function e() {
                    ...
                    u.forEach(function(e, r, o) {
                        ...
                        e.position.y = i,
                        e.move(n),
                        t += (s.position.x - e.position.x) * d,
                        i += (s.position.y - e.position.y) * d
                    }),
                    r = requestAnimationFrame(e)
                }()
            }
        ...
        function o(e) {
            let t, n, r = e && e.element, i = r || document.body, o = window.innerWidth, s = window.innerHeight, a = {
                x: o / 2,
                y: o / 2
            ...
            (o / 2,s / 2,10,10), u = e?.color || "#323232a6", c = window.matchMedia("(prefers-reduced-motion: reduce)");
            function d() {
                if (c.matches)
                    return console.log("This browser has prefers reduced motion turned on, so the cursor did not init"),
                    !1;
                ...
                t.style.left = "0px",
                t.style.pointerEvents = "none",
                r ? (t.style.position = "absolute",
                i.appendChild(t),
                t.width = i.clientWidth,
                t.height = i.clientHeight) : (t.style.position = "fixed",
                document.body.appendChild(t),
                t.width = o,
                t.height = s),
            ...
            function p(e) {
                ...
                r ? (t.width = i.clientWidth,
                t.height = i.clientHeight) : (t.width = o,
                t.height = s)
            }
            function h(e) {
                if (r) {
        ...
        function s(e) {
            let t, n, r, i = e && e.element, o = i || document.body, s = e && e.randomDelay, a = e && e.minDelay || 5, l = e && e.maxDelay || 50, u = window.innerWidth, c = window.innerHeight, d = {
                x: u / 2,
                y: u / 2
            }, p = [], h = new Image;
            e && e.image ? h.src = e.image : h.src = "data:image/png;base64,";
            ...
            function g(e) {
                ...
                i ? (t.width = o.clientWidth,
                t.height = o.clientHeight) : (t.width = u,
                t.height = c)
            }
            function v(e) {
                if (e.touches.length > 0)
                    for (let t = 0; t < e.touches.length; t++)
                        E(e.touches[t].clientX, e.touches[t].clientY, h)
            }
            f.onchange = ()=>{
                f.matches ? _() : m()
            }
            ...
            function _() {
                ...
                o.removeEventListener("touchmove", v),
                o.removeEventListener("touchstart", v),
                window.addEventListener("resize", g)
            }
            function S(e, t, n) {
    ...
    6825: function(e, t, n) {
        ...
        class u extends r.PureComponent {
            constructor() {
                ...
                this.processInput = e=>{
                    ...
                    case "autoreset":
                        ...
                        this.wrapperEl.clientPosition.xPercentage = o(n / i * 100, -100, 100),
                        this.wrapperEl.clientPosition.yPercentage = o(r / s * 100, -100, 100),
                ...
                this.updateClientInput = ()=>{
                    ...
                    if (n) {
                        ...
                        e = r / window.innerHeight * 200 - 100,
                        t = n / window.innerWidth * 200 - 100
                    } else {
                        let {size: {width: n, height: r, left: i, top: o}, clientPosition: {x: s, y: a}} = this.wrapperEl;
                        e = (a - o) / r * 200 - 100,
                        t = (s - i) / n * 200 - 100
                    }
            ...
            initGlare() {
                ...
                e && (this.glare = new s(this.wrapperEl.size,t),
            ...
            emitOnMove(e) {
                ...
                let n = 0
                  , r = 0;
                this.glare && (n = this.glare.glareAngle,
                r = this.glare.glareOpacity),
                t({
