(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[179], {
    ...
    5274: function(e, t, r) {
        ...
        class G extends y.default.Component {
            ...
            componentDidMount() {
                ...
                S.isDynamicRoute)(n.pathname) || location.search || z) || a.props && a.props.__N_SSG && (location.search || z)) && n.replace(n.pathname + "?" + String((0,
                j.assign)((0,
    ...
    5442: function(e, t, r) {
        ...
        function g(e) {
            ...
            , onReady: a=null, strategy: u="afterInteractive", onError: c, ...d} = e
              , {updateScripts: h, scripts: m, getIsSsr: g, appDir: y, nonce: _} = (0,
    ...
    5932: function(e, t, r) {
        ...
        class V {
            ...
            async change(e, t, r, n, a) {
                ...
                this._inFlightRoute && this.clc && (X || V.events.emit("routeChangeError", I(), this._inFlightRoute, K),
                this.clc(),
                this.clc = null),
                r = (0,
                w.addBasePath)((0,
                ...
                if (!F && this.onlyAHashChange(Q) && !Z) {
                    ...
                    try {
                        ...
                        throw (0,
                        u.default)(e) && e.cancelled && V.events.emit("routeChangeError", e, Q, K),
                        e
                    }
                ...
                try {
                    ...
                    if (F || n.shallow || await this._bfl(r, "resolvedAs"in o ? o.resolvedAs : void 0, W.locale),
                    "route"in o && el) {
                        ea = et = o.route || ea,
                        ...
                        p.isDynamicRoute)(et)) {
                            ...
                            w.addBasePath)((0,
                            b.addLocale)(new URL(r,location.href).pathname, W.locale), !0)
                              , t = e;
                            (0,
                            S.hasBasePath)(t) && (t = (0,
                            P.removeBasePath)(t));
                    ...
                    if ((o.__N_SSG || o.__N_SSP) && o.props) {
                        ...
                        if (W.isPreview = !!o.props.__N_PREVIEW,
                        o.props.notFound === H) {
                            let e;
                            try {
            ...
            async getRouteInfo(e) {
                let {route: t, pathname: r, query: n, as: a, resolvedAs: i, routeProps: l, locale: s, hasMiddleware: f, isPreview: d, unstable_skipClientCache: p, isQueryUpdating: h, isMiddlewareRewrite: m, isNotFound: g} = e
                  , _ = t;
                try {
                    var b, v, w, S;
                    let e = G({
                    ...
                    h && (E ? E.json = self.__NEXT_DATA__.props : E = {
                    ...
                    this.isPreview || !x.__N_SSG || h || q(Object.assign({}, O, {
                        isBackground: !0,
                        persistCache: !1,
            ...
            scrollToHash(e) {
                ...
                if ("" === t || "top" === t) {
                    (0,
                    T.handleSmoothScroll)(()=>window.scrollTo(0, 0));
                    return
                }
                ...
                if (n) {
                    (0,
                    T.handleSmoothScroll)(()=>n.scrollIntoView());
                    return
                }
                let a = document.getElementsByName(r)[0];
                a && (0,
                T.handleSmoothScroll)(()=>a.scrollIntoView())
            }
            urlIsNew(e) {
            ...
            constructor(e, t, r, {initialProps: n, pageLoader: a, App: i, wrapApp: l, Component: u, err: s, subscription: c, isFallback: f, locale: m, locales: g, defaultLocale: _, domainLocales: b, isPreview: v}) {
                this.sdc = {},
                this.sbc = {},
